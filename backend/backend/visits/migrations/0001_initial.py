    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicines', models.ManyToManyField(blank=True, null=True, to='visits.medicine')),
                ('patient', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='patients.patient')),
            ],
        ),
        migrations.CreateModel(
            name='Visit',
            fields=[
                ...
                ('doctor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='employees.employee')),
